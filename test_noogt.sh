...
show_usage() {
    ...
    echo "  2: Run step 4 only (testing)"
...
case $MODE in
    1)
        ...
        run_step "Running node feature creation" "script_features" "get_features_test.py" "2"
        ...
        run_step "Running testing" "script_noogt" "main_test.py" "4"
        ;;
        
    2)
        # Mode 2: Only step 4
        echo "Mode 2: Running step 4 only (testing)"
        echo "========================================="
